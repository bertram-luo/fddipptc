	...
	<div class="jumbotron">
		...
		<form method='post' enctype="multipart/form-data" action="proposal/insert" class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<span id="ref_locs">
						<input class="input-small form-control" id="ref_locsID" type="text" name="ref_locs[]" placeholder="文献地点，例如：中国大陆东北吉林长春朝阳区"  />
					</span>
			...
			<div class="control-group">
				...
				<div class="controls">
					<span id="gov_loc">
						<input class="input" id="govID" type="text" name="gov_loc[]" placeholder="政府，例如：上海市政府，杨浦区政府" />
					</span>
					<button id="add_gov_loc"><i class="icon-plus"></i></button>
				</div>
			</div>
			<div class="control-group">
...
<script>
	$(document).ready(function(){
		...
		$('#add_gov_loc').click(function(){
			$('#gov_loc').append("<input class='input-small form-control' type='text' name='gov_loc[]' placeholder='政府' />"); 
			return false;
		});
